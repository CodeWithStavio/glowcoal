...
export default function Footer() {
  return (
    <footer id="contact" className="relative pt-32 pb-8">
      ...
      {/* Main Footer Content */}
      <div className="relative z-10 bg-navy-600/50 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                شركة رائدة في إنتاج وتصدير الفحم المضغوط عالي الجودة. نلتزم
                بتقديم أفضل المنتجات لعملائنا حول العالم.
              </p>
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 bg-gold/10 rounded-full flex items-center justify-center text-gold hover:bg-gold hover:text-navy transition-colors duration-300"
                >
                  <svg
            ...
            >
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 text-gold flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          <div className="container-custom py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-400 text-sm">
                © {new Date().getFullYear()} جلو كول. جميع الحقوق محفوظة.
              </p>
              <p className="text-gray-400 text-sm">
