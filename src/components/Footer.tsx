      ...
      <div className="footer-split min-h-[500px]">
          ...
          >
            ...
            <Link href="/" className="inline-block mb-8">
              <Logo className="h-56 md:h-64 w-auto" />
            </Link>
            ...
            <div className="space-y-4 mb-8">
              ...
              >
                ...
                <span className="text-lg" dir="ltr">+963 99 123 0605</span>
              </a>
              ...
              >
                ...
                <span className="text-lg" dir="ltr">+963 933 292 192</span>
              </a>
